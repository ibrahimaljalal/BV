...
createApp({
  template: `
    ...
    <div class="container-for-a" @click="updateColors" @mouseenter="targetTimeCoef = 100" @mouseleave="targetTimeCoef = 1" >
    <a @click="updateColors" @mouseenter="targetTimeCoef = 100" @mouseleave="targetTimeCoef = 1"

    target="_blank"
    href="user_guides/index.html#generate_code"
    ...
    >Speed up your development process !</a>
    </div>
  `,
